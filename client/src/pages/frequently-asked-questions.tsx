...
const FAQPage = ({location}: IFAQPageProps) => {
  ...
  const ANSWERS = [
    ...
    <>
      ...
      <p>{FAQS_COPY.FAQ_ANSWERS.Q5_P2_1}</p>
    </>,
    <>
      ...
      <div style={dotStyles}>
        <img
          ...
          alt={intl.formatMessage(
              SIDE_PANEL_INIT_STATE_ICON_ALT_TEXT.DAC_CIRCLE,
          )}
        />
  ...
  return (
    <Layout
      location={location}
      title={intl.formatMessage(FAQS_COPY.PAGE_INTRO.PAGE_TILE)}
    >
