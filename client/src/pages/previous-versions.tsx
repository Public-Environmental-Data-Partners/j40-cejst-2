...
const PreviousVersions = ({location}: IPreviousVersionsProps) => {
  ...
  return (
    <Layout
      location={location}
      title={intl.formatMessage(PREV_VER_COPY.PAGE.TITLE)}
    >
        ...
        <Grid row gap className={'j40-mb5-mt3'}>
          ...
          <Grid col={12} tablet={{col: 8}}>
            <section style={containerStyle}>
              <CardGroup>
                <Card
                  className="previous-versions-container"
                ...
                >
                  ...
                  <CardFooter>
                    <DownloadButton
                      downloadLink={getDownloadFileUrl(
                          process.env
                              .GATSBY_FILE_DL_PATH_BETA_TRAINING_SLIDES_PPT,
                          VERSIONS.BETA,
                      )}
                      buttonText={intl.formatMessage(
                          PREV_VER_COPY.VIDEO.BUTTON2_TEXT,
                      )}
                      imageAltTagText={intl.formatMessage(
                          PREV_VER_COPY.VIDEO.IMG_ALT_TEXT2,
                      )}
                      color={'default'}
                    />
                    <DownloadButton
                      downloadLink={getDownloadFileUrl(
                          process.env.GATSBY_FILE_DL_PATH_BETA_DATA_DOC,
                          VERSIONS.BETA,
                      )}
                      buttonText={intl.formatMessage(
                          PREV_VER_COPY.BUTTON.TITLE1,
                      )}
                      imageAltTagText={intl.formatMessage(
                          PREV_VER_COPY.BUTTON.BUTTON1_ALT_TAG,
                      )}
                      color={'default'}
                    />
                    <DownloadButton
                      downloadLink={getDownloadFileUrl(
                          process.env.GATSBY_FILE_DL_PATH_BETA_SHAPE_FILE_ZIP,
                          VERSIONS.BETA,
                      )}
                      buttonText={intl.formatMessage(
                          PREV_VER_COPY.BUTTON.TITLE2,
                      )}
                      imageAltTagText={intl.formatMessage(
                          PREV_VER_COPY.BUTTON.BUTTON2_ALT_TAG,
                      )}
                      color={'default'}
                    />
                    <a
                      className="previous-versions-demoLink"
                      href="https://www.youtube.com/watch?v=QwHWcXbhw28"
                      target={'_blank'}
                      rel="noreferrer"
                    >
                      <Button type="button" className="youTubeBtn">
                        <div className="buttonContainer">
                          <div className="buttonText">
                            {intl.formatMessage(
                                PREV_VER_COPY.VIDEO.BUTTON1_BETA_TEXT,
                            )}
                          </div>
                          <img
                            ...
                            alt={intl.formatMessage(
                                PREV_VER_COPY.VIDEO.IMG_ALT_TEXT1,
                            )}
                          />
                        </div>
                      </Button>
                ...
                >
                  ...
                  <CardFooter>
                    <DownloadButton
                      downloadLink={getDownloadFileUrl(
                          process.env.GATSBY_FILE_DL_PATH_1_0_DATA_DOC,
                          VERSIONS.V1_0,
                      )}
                      buttonText={intl.formatMessage(
                          PREV_VER_COPY.BUTTON.TITLE1,
                    ...
                    <DownloadButton
                      downloadLink={getDownloadFileUrl(
                          process.env.GATSBY_FILE_DL_PATH_1_0_SHAPE_FILE_ZIP,
                          VERSIONS.V1_0,
                      )}
                      buttonText={intl.formatMessage(
                          PREV_VER_COPY.BUTTON.TITLE2,
                    ...
                    >
                      <Button type="button" className="youTubeBtn">
                        <div className="buttonContainer">
                          <div className="buttonText">
                            {intl.formatMessage(
                                PREV_VER_COPY.VIDEO.BUTTON1_1_0_TEXT,
                            )}
                          </div>
                          <img
                            className="buttonImage"
